            ...
            <div class="main task-list">
                ...
                <div class="has-content" style="">
                    <div class="bottomList">
                        <%
                            for (Grouping<Integer,User> group: grouped)
                            {
                        %>
                        <div tabindex="18" class="status"><%=Methods.getUserTypeStr(group.getKey())%>(<%=group.getItems().length%>)</div>
                        <ul>
                            <%
                                User[] users = group.getItems();
