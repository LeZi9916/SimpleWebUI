...
<div class="box">
    ...
    <div class="nav_side ">
        ...
        <div class="sideCon" id="boxscrollleft" tabindex="1" style="height: 931px; overflow: hidden; outline: none;">
            <dl class="classDl">
                <dt>
                ...
                <dd class="textHidden colorDeep"></dd>
            </dl>
            <div class="nav-content   stuNavigationList">
                <ul>
                    ...
                    <li opentype="0" dataname="zj" pageheader="1" class="curNav" id="nav_38236" data="38236" shownewmark="0">
                        <a href="userInfo.jsp">
									<span class="tag_new">
										<span class="nav_content">
											用户信息
        ...
        <form id="tpsubmit" action="https://mooc1.chaoxing.com/course/243353784.html?clazzId=98918368"
              target="_blank" method="post">
        </form>
        <div id="ascrail2000" class="nicescroll-rails nicescroll-rails-vr" style="width: 8px; z-index: 2; cursor: default; position: absolute; top: 52px; left: 172px; height: 931px; display: none; opacity: 0;">
            <div class="nicescroll-cursors" style="position: relative; top: 0px; float: right; width: 8px; height: 0px; background-color: rgb(230, 236, 245); background-clip: padding-box; border-radius: 5px;">
            </div>
        </div>
        <div id="ascrail2000-hr" class="nicescroll-rails nicescroll-rails-hr"
             style="height: 8px; z-index: 2; top: 975px; left: 0px; position: absolute; cursor: default; display: none; opacity: 0;">
            <div class="nicescroll-cursors" style="position: absolute; top: 0px; height: 8px; width: 0px; background-color: rgb(230, 236, 245); background-clip: padding-box; border-radius: 5px; left: 0px;">
            </div>
        </div>
    </div>
</div>
<div id="frame_content-hd" width="1868" height="931"
        ...
        <div id="main" class="clear" style="min-width: 1060px; overflow-x: auto;">
            <div class="main task-list">
                ...
                <div class="has-content" style="display: flex; height: 450px;justify-content: center; align-items: center; position: relative;align-items: center;">
                    <!-- List  -->
                    <form action="updateUserInfo.jsp" method="post" enctype="multipart/form-data" style="display: flex; height: 450px;justify-content: center; align-items: center; position: relative;align-items: center;">
                        <div style="flex: 0 0 50%; display: flex; justify-content: center; align-items: center;margin: auto 0;flex-direction:column">
                            <img height="240px" src="<%=request.getContextPath() + "/pic/" + user.getPicId() + ".jpg"%>">
